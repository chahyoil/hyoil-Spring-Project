			...
			<div class="cs-view-information-content" id="cs-notice">
				<div id="notice-wrapper">
					<div class="notice-board">
						...
						<tbody>
							<c:forEach items="${admin_buyList }" var="admin_buyList">
								<tr onmouseover="this.style.background='#F7F7F7'"
									onmouseout="this.style.background=''">
									<td>${admin_buyList.pid }</td>
									<td><a
										href="admin_ProductContentView.do?pid=${admin_buyList.pid  }">${admin_buyList.pname }</a></td>
									<td>${admin_buyList.pimage }</td>
									<td>${admin_buyList.phiredate }</td>
									<td>${admin_buyList.phit }</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
