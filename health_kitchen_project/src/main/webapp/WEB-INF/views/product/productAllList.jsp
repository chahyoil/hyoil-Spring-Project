...
<div id="content" class="clear">
	<div class="rcr_lnb">
		<ul class="cateList">
			...
			<li>
				<a href="admin_OrderList.do">물품 구매현황</a>
			</li> 
			<li>
				...
				<div id="notice-wrapper">
					<div class="notice-board">
						...
						<table class="board-table-header">
							<tbody>
								<tr>
									<th width="70" scope="col" class="input_txt">제품번호</th>
									<th width="*" scope="col" class="input_txt">제품명</th>
									<th width="87" scope="col" class="input_txt">제품이미지</th>
									<th width="80" scope="col" class="input_txt">제품등록날짜</th>
						...
						<tbody>
							<c:forEach items="${productAllList }" var="productAllList">
								<tr onmouseover="this.style.background='#F7F7F7'"
									onmouseout="this.style.background=''">
									<td>${productAllList.pid }</td>
									<td>
										<a href="admin_ProductContentView.do?pid=${productAllList.pid  }">${productAllList.pname }</a></td>
									<td>${productAllList.pimage }</td>
									<td><fmt:formatDate value="${productAllList.phiredate }" type="both" pattern="yyyy-MM-dd"/></td>
									<td>${productAllList.phit }</td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
						...
						<p class="btnArea">
							<span class="btn_button" style="line-height: 30px; width: 130px"
								onclick="location.href='admin_ProductInsertView.do'"> 물품등록 </span>
						</p>
						<!-- btnArea -->
					</div>
					<!-- notice-board -->
